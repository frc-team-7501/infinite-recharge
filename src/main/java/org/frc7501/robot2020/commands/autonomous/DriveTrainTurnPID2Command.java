...
public class DriveTrainTurnPID2Command extends PIDCommand {
...
private static double normalizedAngle(double angle) {
  ...
  public DriveTrainTurnPID2Command(DriveTrain driveTrain, double setpoint) {
    super(
      // PID controller
      new PIDController(0.03, 0.003, 0.015),
      // Measurement
...
getController().enableContinuousInput(0, 360);
    ...
    // Tune the PID
    getController().setTolerance(4, 15);
  }
